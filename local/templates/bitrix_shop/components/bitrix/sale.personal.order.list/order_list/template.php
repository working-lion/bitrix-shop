...
else
{
	...
	<div class="row col-md-12 col-sm-12">
		...
		{
			?>
			<a class="sale-order-list-link sale-order-history-link" href="<?=$APPLICATION->GetCurPageParam("filter_history=Y", $clearFromLink, false)?>">
		...
		{
			?>
			<a class="sale-order-list-link sale-order-history-link" href="<?=$APPLICATION->GetCurPageParam("", $clearFromLink, false)?>">
			...
			{
				?>
				<a class="sale-order-list-link sale-order-history-cancel-link" href="<?=$APPLICATION->GetCurPageParam("filter_history=Y&show_canceled=Y", $clearFromLink, false)?>">
	...
	if (!count($arResult['ORDERS']))
	{
		?>
		<div class="row col-md-12 col-sm-12">
			<a href="<?=htmlspecialcharsbx($arParams['PATH_TO_CATALOG'])?>" class="sale-order-list-link sale-order-catalog-link">
	...
	?>
	<div class="row col-md-12 col-sm-12">
		<a href="/partner/" class="sale-order-list-link sale-order-partners-link">Партнёры</a>
	</div>
	<?
