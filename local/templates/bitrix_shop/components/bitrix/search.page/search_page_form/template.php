...
?><br /><div class="search-page search">
...
<?else:?>
	<input type="text" class="input_search" name="q" value="<?=$arResult["REQUEST"]["QUERY"]?>" size="40" />
<?endif;?>
...
<?endif;?>
	&nbsp;<input type="submit" class="submit_search" value="<?=GetMessage("SEARCH_GO")?>" />
