	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-md-6 col-sm-12">
				...
				<?
				//если указано свойство Партнёр, то выводим блок с описанием партнёра
				foreach ($arResult['DISPLAY_PROPERTIES'] as $property)
				{
					//если текущее свойство - партнёр
					//в массиве будет строка вила: <a href="/partner/18">Партнёр 1</a>
					if ($property['ID'] == 17) {
						$indexStart = strripos($property['DISPLAY_VALUE'], '/partner/');
						$indexEnd = stripos($property['DISPLAY_VALUE'], '>');
						$indexStart += 9;
						$partnerID = mb_strcut($property['DISPLAY_VALUE'], $indexStart, $indexEnd - $indexStart - 1);
					}
				}
				if (isset($partnerID)) {
					if(CModule::IncludeModule('iblock') && ($arIBlockElement = GetIBlockElement($partnerID, 'partner'))) {
						?>
						<div class="row">
							<div class="partner-info">
								<h3><?=$arIBlockElement['NAME']?></h3>
								<h4>Описание</h4>
						...
						ShowError('Информация о партнёре не найдена.');
					}
				}
				?>
			</div>
